...
export default function Logo({
  ...
  const subtextColor = variant === 'light' ? '#6ee7b7' : '#f37023';
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Sun Body */}
        <circle cx="50" cy="50" r="32" fill="url(#adminSunGrad)" />
        ...
        <path
          ...
          fill="none"
        />
        <path d="M42 66 Q50 72 58 66" fill="#DC2626" />
        ...
        <defs>
          <radialGradient id="adminSunGrad" cx="40%" cy="40%" r="60%">
